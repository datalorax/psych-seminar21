...
`r icons::fontawesome("twitter")` [@datalorax_](https://twitter.com/datalorax_)
`r icons::fontawesome("github")` [@datalorax](https://github.com/datalorax)
`r icons::fontawesome("envelope")` [daniela@uoregon.edu](mailto:daniela@uoregon.edu)
